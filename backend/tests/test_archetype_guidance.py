...
async def test_archetype_recommendations_role_confusion():
    ...
    l1_result = {'score': 0.3, 'confidence': 0.7, 'uncertainty': 0.3,
                 'indicators': {}, 'archetypes': []}
    l2_result = {'score': 0.6, 'confidence': 0.8, 'uncertainty': 0.2,
                 'indicators': {}, 'archetypes': [FailureArchetype.ROLE_CONFUSION]}
    l3_result = {'score': 0.2, 'confidence': 0.6, 'uncertainty': 0.3,
                 'indicators': {}, 'archetypes': []}
...
async def test_no_archetypes_provides_default_guidance():
    ...
    l1_result = {'score': 0.2, 'confidence': 0.7, 'uncertainty': 0.3,
                 'indicators': {}, 'archetypes': []}
    l2_result = {'score': 0.3, 'confidence': 0.8, 'uncertainty': 0.2,
                 'indicators': {}, 'archetypes': []}
    l3_result = {'score': 0.1, 'confidence': 0.6, 'uncertainty': 0.3,
                 'indicators': {}, 'archetypes': []}
