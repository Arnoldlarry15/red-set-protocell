...
def _minimal_deps():
    return {
        ...
        "export_early_access_signups": _json_response({"count": 0, "signups": []}),
        "delete_early_access_signup": _json_response({"deleted": True}),
        "verify_early_access_signup": _json_response({"verified": True}),
