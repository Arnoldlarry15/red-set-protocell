...
async def test_sequential_execution():
    ...
    state_manager = StateManager(database_path="/tmp/test_sequential.db", zero_retention=True)
...
async def test_parallel_execution():
    ...
    scoring_engine = ScoringEngine()
    state_manager = StateManager(database_path="/tmp/test_parallel.db", zero_retention=True)
...
async def test_parallel_with_timeout():
    ...
    scoring_engine = ScoringEngine()
    state_manager = StateManager(database_path="/tmp/test_timeout.db", zero_retention=True)
